...
export const Hero: React.FC<HeroProps> = ({ guestName, onNavigate }) => {
    ...
    <section id={SectionId.HERO} className="relative h-screen min-h-[700px] w-full overflow-hidden flex items-center justify-center bg-wedding-900">
      ...
      <div className="relative z-10 text-center text-white px-4 animate-fade-in-up flex flex-col items-center max-w-4xl mx-auto">
        ...
        <button
          ...
          className="mt-8 px-8 py-3 bg-white/10 backdrop-blur-md border border-white/40 text-white rounded-full font-medium tracking-wide uppercase text-sm hover:bg-white/20 hover:scale-105 transition-all shadow-[0_0_20px_rgba(255,255,255,0.2)]"
        >
