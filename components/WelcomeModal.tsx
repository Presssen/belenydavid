...
import { X, CalendarClock, ChevronRight, Plane, CheckCircle2 } from 'lucide-react';
      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden relative animate-fade-in-up border border-wedding-100">
        ...
        <div className="p-8 text-center">
          ...
          <div className="space-y-3">
            <button 
              onClick={handleRSVP}
              className="w-full py-3 bg-wedding-800 text-white rounded-xl font-medium shadow-lg shadow-wedding-800/20 hover:bg-wedding-900 transition-all active:scale-95 flex items-center justify-center gap-2"
            >
